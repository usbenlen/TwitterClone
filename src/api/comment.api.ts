...
const realCommentApi = {
  ...
  delete: (id: string) =>
      apiClient.delete<void>(ENDPOINTS.comments.delete(id)),

  like: (id: string) =>
      apiClient.post<ToggleCommentLikeResponse>(
          ENDPOINTS.comments.like(id),
      ),

  unlike: (id: string) =>
      apiClient.delete<ToggleCommentLikeResponse>(
          ENDPOINTS.comments.unlike(id),
      ),
  ...
  toggleLike: (
      ...
      likedByMe
          ? realCommentApi.unlike(id)
          : realCommentApi.like(id),

  repost: (id: string) =>
      apiClient.post<ToggleCommentRepostResponse>(
          ENDPOINTS.comments.repost(id),
      ),
  ...
  ): Promise<ToggleCommentRepostResponse> =>
      repostedByMe
          ? realCommentApi.unrepost(id)
          : realCommentApi.repost(id),
  ...
  ): Promise<ToggleCommentBookmarkResponse> =>
      bookmarkedByMe
          ? realCommentApi.unbookmark(id)
          : realCommentApi.bookmark(id),

  view: (id: string) =>
      apiClient.post<void>(ENDPOINTS.comments.view(id)),
};

export const commentApi = MOCK_ENABLED
    ? mockCommentApi : realCommentApi;