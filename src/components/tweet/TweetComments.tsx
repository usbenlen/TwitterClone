...
import { CommentList, CommentToolbar } from "@/components/tweet/comment";
...
export default function TweetComments({
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!normalizedContent || isSubmitting) return;

    const success = await onSubmit(normalizedContent, null);
  ...
  return (
    <section data-tweet-interactive="true">
      {/* Composer */}
      <form
              ...
              <div className="relative">
                ...
                <div className="flex items-center justify-between gap-3">
                  <CommentToolbar
                    ...
                    emojiButtonRef={refs.setReference}
                  />
